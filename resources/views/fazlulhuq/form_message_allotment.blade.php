...
<h3 style="color:DarkBlue;">Your Form was submitted successfully</h3>
...
<div class="container">
  ...
  <form class="form-horizontal" action="allotment_submit" method="post">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="copy_marksheet_previous_exam">A certified copy of the marksheet of the previous exam:</label>
      <div class="col-sm-6">
        <input type="file" class="form-control" name="copy_marksheet_previous_exam" required>
      </div>
    </div>
